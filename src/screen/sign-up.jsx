...
import Inputs, { PasswordInputs, Select } from "../component/inputs";
import Buttons from "../component/buttons/buttons";

const SignUp = ({ onClick, openLogin }) => {
      ...
      >
        <div className="flex justify-between items-center">
          ...
          <p className="text-sm font-OpenSans text-gray-400 w-32">
            ...
            <span onClick={openLogin} className="text-red-300 cursor-pointer">
              Login
            </span>
          </p>
        </div>
        ...
        <div className="flex items-center justify-between mt-5">
          <div>
            <Select
              css={"h-[30px] outline-none text-[13px]"}
              optone="Gender"
              opttwo="Male"
              optthree="Female"
              optfour="Other"
